...
class Mtx33
{
	...
	//public var a00(get, null) : Float;
	//public var a01(get, null) : Float;
	//public var a02(get, null) : Float;
	
	//no deep copy, to contstruct, use from* function set
	function new(?v0:Vec3,?v1:Vec3,?v2:Vec3)
	{
